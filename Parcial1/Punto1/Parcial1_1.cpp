...
const int N=3;
const double Lx=40;
const double x10=10, x20=20, x30=30;
...
void Colisionador::CalculeFuerzas(Cuerpo * Grano){
  ...
  vector3D F1,F2,F3;
  double f1 = -k*x1+k*(x2-x1);
  double f2 = -k*(x2-x1)+k*(x3-x2);
  double f3 = -k*(x3-x2)-k*x3;
...
void InicieAnimacion(void){
  ...
  cout<<"set output 'OscilaciónLibre.gif'"<<endl;
  cout<<"unset key"<<endl;
...
int main(void){
  ...
  Grano[0].Inicie(x10+2,0,0,0,m,R);
